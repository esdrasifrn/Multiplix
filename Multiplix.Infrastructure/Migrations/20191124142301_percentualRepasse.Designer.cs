...
namespace Multiplix.Infrastructure.Migrations
{
    ...
    [Migration("20191124142301_percentualRepasse")]
    partial class percentualRepasse
    {
            ...
            modelBuilder.Entity("Multiplix.Domain.Entities.Associado", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Nascimento = new DateTime(2019, 11, 24, 11, 23, 0, 443, DateTimeKind.Local).AddTicks(1831),
                            Nivel = 0,
                            PlanoAssinaturaId = 1,
                            TipoConta = 1,
                            UsuarioId = 1
